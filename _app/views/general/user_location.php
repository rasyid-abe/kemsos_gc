            ...
            <div class="form_dt_search hidden" id="form_dt_search">                
                ...
                <div class="row"> 
                    <div class="form-group col-sm-3">
                        <input type="text" id="user_id" class="form-control" value="" placeholder="User ID">
                    </div>     
                    <div class="form-group col-sm-3">
                        <input type="text" id="usr" class="form-control" value="" placeholder="Username">
                    </div>  
                    <div class="form-group col-sm-3">
                        <input type="text" id="grups" class="form-control" value="" placeholder="Group">
                    </div>   
                    <div class="form-group col-sm-3">
                        <input type="text" id="namas" class="form-control" value="" placeholder="Nama Lengkap">
                    </div>                              
                </div>
                <div class="row">                             
                    <div class="col-sm-2">
